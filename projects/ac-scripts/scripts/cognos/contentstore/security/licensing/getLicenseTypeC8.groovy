...
rolesEnhancedConsumer = rolesConsumer + 'canUseMobileService' + 'canUseCognosInsight' + 'canUseDashboardViewer'+ 'canUseIndexSearch' + 'canCollaborate'+'canUseCollaborationFeatures'+'canLaunchCollaborationTools'+'canUseMonitorActivityTool'+'canUseHTML'+'canUseUserDefinedSQL'+'canUseBursting'
...
rolesProfessional = rolesProfessionalAuthor + _metricStudio + 'canUseEventStudio'+ 'canUseAnalysisStudio'+'canUsePowerPlay'+'canUseAdaptiveAnalytics'
